    ...
    public class CCScale9Sprite : CCNode
    {
        ...
        */
        ...
        public CCScale9Sprite()
            : this((CCSpriteBatchNode)null, CCRect.Zero, CCRect.Zero)
        {
        }

        public CCScale9Sprite(CCRect capInsets)
            : this((CCSpriteBatchNode)null, CCRect.Zero, capInsets)
        {
        }
        ...
        public CCScale9Sprite(string file, CCRect rect, CCRect capInsets)
            : this(new CCSpriteBatchNode(file, 9), rect, capInsets)
        {
        }

        public CCScale9Sprite(string file, CCRect rect)
            : this(file, rect, CCRect.Zero)
        {
        }

        public CCScale9Sprite(string file)
            : this(file, CCRect.Zero)
        {
        }
